...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                {{ $deals_not_closed[0]->user_industry }}
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools">                                
                                <a href="{{ URL::to('/') }}/admin/deals-not-closed-by-industry-export/{{ $deals_not_closed[0]->user_industry }}" class="btn btn-primary btn-sm active" role="button">Download</a>
                            </div>
                        </div>
